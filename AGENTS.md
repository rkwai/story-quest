...
- Live turns use engine 1.1.0 and mandatory `itemActions`; validate item ownership, reach, quantity and availability before other consequences. Do not bypass inventory with generic owner/location updates, direct player-owned item creation, facts or narration. See docs/inventory.md before changing this path.
