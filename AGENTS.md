...
Rick's Story layout order is action input, newest scene, then scrollable older interactions newest first. Do not display chronology headings such as “Latest interaction” or “Past story.” Reverse presentation only; preserve chronological saved history and replay. Keep pending/errors beside the composer. Within an interaction, show narration before the submitted action and change notes. Bring the response to the player’s own new submission into view when ready; do not scroll to the history bottom or pull readers away when they retry older narration. Ctrl+Enter submits the action; Enter alone inserts a new line.
